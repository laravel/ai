...
trait GeneratesTranscriptions
{
    ...
    public function transcribe(
        ...
        $prompt = new TranscriptionPrompt($audio, $language, $diarize, $this, $model, $timeout, $providerOptions, $headers);
        ...
        return tap($this->transcriptionGateway()->generateTranscription(
            $this, $model, $prompt->audio, $prompt->language, $prompt->diarize, $prompt->timeout ?? 30, $prompt->providerOptions, $prompt->headers
