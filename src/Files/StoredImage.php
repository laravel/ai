...
class StoredImage extends Image implements Arrayable, InlineSerializable, JsonSerializable, StorableFile
{
    use CanBeUploadedToProvider, EncodesContentAsBase64, SerializesImageContent;
