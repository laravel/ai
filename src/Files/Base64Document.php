...
class Base64Document extends Document implements Arrayable, InlineSerializable, JsonSerializable, StorableFile
{
    use CanBeUploadedToProvider, HasStoredBase64, SerializesDocumentContent;
