...
class Base64Document extends Document implements Arrayable, EmbeddableFile, JsonSerializable, StorableFile
{
    use CanBeUploadedToProvider, HasBase64Content, SerializesEmbeddableDocument;
