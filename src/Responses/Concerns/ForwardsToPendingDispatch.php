...
/**
 * Forwards queue configuration calls to the pending dispatch, returning the queued response for fluency.
 *
 * @property PendingDispatch $dispatchable
 */
trait ForwardsToPendingDispatch
{
    /**
