...
class OpenRouterImageGatewayTest extends TestCase
{
    ...
    public function test_it_sends_attachments_as_image_url_content_parts(): void
    {
        Http::fake([
            'openrouter.ai/api/v1/chat/completions' => Http::response([
                'choices' => [
                    [
                        'message' => [
                            'images' => [
                                [
                                    'image_url' => [
                                        'url' => 'data:image/png;base64,'.base64_encode('edited'),
                                    ],
                                ],
                            ],
                        ],
        ...
        Http::assertSent(function ($request) {
            ...
            return is_array($content)
                && $content[0]['type'] === 'text'
                && $content[0]['text'] === 'Edit this image to add a sunset'
